...
import { useFolderContent, useFolderContentStore } from "../../stores/folderContentStore";
...
export function OptionsPage(): ReactElement {
  ...
  const updateOptionsContent = useFolderContentStore(state => state.updateOptionsContent);
  ...
  return (
    <div className={styles.optionsPage}>
      ...
      <div className={styles.pageHeader}>
        ...
        <div className={styles.autoSaveInfo}>Changes are saved automatically</div>
      </div>
